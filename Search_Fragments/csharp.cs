...
namespace LearnToShare.Search_Fragments
{
    ...
    public class csharp : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            This_View = inflater.Inflate(Resource.Layout.fragment_csharp_search, container, false);
        ...
        {
            Intent Csharp = new Intent(This_View.Context, typeof(Activities.Activity_csharp));
            StartActivity(Csharp);
        }

        private void Btn3_Click(object sender, EventArgs e)
        {
            Intent Winform = new Intent(This_View.Context, typeof(Activities.Activity_winform));
            StartActivity(Winform);
        }
        private void Btn2_Click(object sender, EventArgs e)
        {
            Intent XamarinAndroid = new Intent(This_View.Context, typeof(Activities.Activity_xamarin_android));
            StartActivity(XamarinAndroid);
        }
        private void Btn1_Click(object sender, EventArgs e)
        {
            Intent XamarinForm = new Intent(This_View.Context, typeof(Activities.Activity_xamarin_form));
