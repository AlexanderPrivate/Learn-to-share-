...
namespace LearnToShare.Search_Fragments
{
    ...
    public class thevs : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            This_View = inflater.Inflate(Resource.Layout.fragment_vscode_search, container, false);
        ...
        {
            Intent Vs = new Intent(This_View.Context, typeof(Activities.Activity_vscode));
            StartActivity(Vs);
        }
    }
}