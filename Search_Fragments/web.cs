...
namespace LearnToShare.Search_Fragments
{
    ...
    public class web : Fragment
    {
        ...
        {
            This_View = inflater.Inflate(Resource.Layout.fragment_web_search, container, false);
        ...
        {
            Intent Web = new Intent(This_View.Context, typeof(Activities.Activity_htmlcss));
            StartActivity(Web);
        }
    }
}