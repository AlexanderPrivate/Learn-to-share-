...
namespace LearnToShare.Search_Fragments
{
    ...
    public class python : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            This_View = inflater.Inflate(Resource.Layout.fragment_python_search, container, false);
        ...
        {
            Intent Python = new Intent(This_View.Context, typeof(Activities.Activity_python));
