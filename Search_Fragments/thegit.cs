...
namespace LearnToShare.Search_Fragments
{
    ...
    public class thegit : Fragment
    {
        ...
        {
            This_View = inflater.Inflate(Resource.Layout.fragment_git_search, container, false);
        ...
        {
            Intent Git = new Intent(This_View.Context, typeof(Activities.Activity_git));
            StartActivity(Git);
        }
    }
}
