...
{
    [Obsolete]
    public class algoritm : Fragment
    {
        View This_View;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            This_View = inflater.Inflate(Resource.Layout.fragment_algoritm_search, container, false);
        ...
        {
            Intent algo = new Intent(This_View.Context, typeof(Activities.Activity_algoritm));
            StartActivity(algo);
        }
    }
}