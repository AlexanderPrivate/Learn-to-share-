...
namespace LearnToShare.html
{
    ...
    public class html_css_adapter : RecyclerView.Adapter
    {
        List<data> datas;
        public html_css_adapter(List<data> datas)
        {
            this.datas = datas;
        }
