...
{
    [Obsolete]
    public class Song_Help : Fragment
    {
        CheckBox check;
        [Obsolete]
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View This_View = inflater.Inflate(Resource.Layout.fragment_songhelp, container, false);
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            if (check.Checked)
            {
                ...
                Transaction.Commit();
                Activity_main.Song_Open = false;
                Activity_main.MyEditor.PutBoolean("Song_Open", false);
